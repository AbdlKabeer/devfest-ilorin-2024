...
const NewHomeHeroNew = () => {
  const eventDate = new Date('April 12, 2025 08:00:00');
  ...
  return (
    <section className="px-4 lg:px-20 bg-[#F0F0F0] pt-10 h-[calc(100vh_-_130px)]">
      <div className="container mx-auto flex flex-col items-center justify-center gap-2 relative z-10 h-full">
        <Confetti isActive={showConfetti} />
        <div className="w-full relative">
          <div className="hidden lg:block">{/* <FloatingIcons /> */}</div>

          <div className="container mx-auto px-4 py-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">

              <div className="h-55 max-w-[800px] mx-auto flex items-center justify-center">
                <Image
                  src="/buildwai/BWAI25-Email-Header.png"
                  width={800}
                  height={450}
                  alt="bwai logo"
                  className="w-full"
              ...
              {/* <p className="text-xl max-w-[530px] mx-auto mt-9 md:text-2xl mb-10 text-gray-700">
                ...
                <>
                  <div className="mb-6">
                    <span className="block text-lg text-gray-600 mb-2">
                      <strong>Main Event Starts In:</strong>
                    </span>
                  ...
                  <div className="flex flex-col lg:flex-row justify-between gap-5 lg:px-10 mt-5 w-full ">
                    <Button
                      ...
                      bgColor={'#ffe7a5'}
                      color={'#000'}
                      className="flex items-center hover:opacity-80 gap-2 !font-bold w-full hover:!bg-[#FFE7A5]/80"
                    >
                      Generate DP!
                    </Button>
                    ...
                    <Button
                      ...
                      bgColor={'#ffe7a5'}
                      color={'#000'}
                      className="flex items-center gap-2 hover:opacity-80 !font-bold w-full hover:!bg-[#FFE7A5]/80"
                    >
