...
import whiteImage from '@public/buildwai/IWA_Perfect.png';
    ...
    if (canvasRef.current && selectedColor) {
      ...
      if (ctx) {
        ...
        backgroundImage.onload = () => {
          ...
          const textX = width * 0.75; // horizontal positioning of name
          const textY = height * 0.60; // vertical positioning of name
